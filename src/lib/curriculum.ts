// বাংলাদেশের NCTB ২০২৬ পাঠ্যক্রম অনুযায়ী শ্রেণিভিত্তিক বিষয় ও অধ্যায়
// (সংক্ষিপ্ত — MCQ জেনারেশনের জন্য টপিক হিসেবে ব্যবহৃত)
...
export function getSubjects(classLevel: string): Subject[] {
